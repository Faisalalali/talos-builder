...
Each release contains disk images and installer images for Raspberry Pi 5.
...
- **Push a tag** matching `v*.*.*` — this builds Raspberry Pi 5 images and creates a GitHub Release:
  ```bash
  git tag v1.11.6
